...
results.to_csv(output_folder / "analysis_bellow30s_01.csv")
figure.savefig(output_folder / "analysis_bellow30s_01.png")
...
# Save the plot and the results
results = DataFrame(results, columns=columns_labels).set_index("event")
results.to_csv(output_folder / "analysis_fluctuations_bellow30s_01.csv")
figure.savefig(output_folder / "analysis_fluctuations_bellow30s_01.png")
