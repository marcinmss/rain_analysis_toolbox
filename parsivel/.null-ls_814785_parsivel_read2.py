from parsivel.parsivel_dataclass2 import ParsivelTimeSeries, ParsivelInfo
...
def read_from_zips(beg: int, end: int, source_folder: str | Path) -> ParsivelTimeSeries:
    ...
    # Creates a temporary Storage folder and empty if it exists
