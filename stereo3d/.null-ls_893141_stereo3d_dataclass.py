...
class Stereo3DSeries:
    ...
    def npa(self, interval_seconds: int) -> ndarray[float, Any]:
    ...
    def split_by_distance_to_sensor(self, number_of_splits: int):
        from stereo3d.indicators import split_by_distance_to_sensor
