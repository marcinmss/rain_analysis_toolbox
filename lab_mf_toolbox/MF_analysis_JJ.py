...
# -*- coding: utf-8 -*-
"""
Created on Mon Jul 25 21:07:41 2022
...
from .Additional_tools_v2 import *
...
plot_index = 15
plt.figure(250)
if scaling_regime == "3_scale":
    k_range = [(1, 2**sc), (2**sc, 2**sc2), (2**sc2, np.int0(N / 2) - 1)]
if scaling_regime == "2_scale":
    k_range = [(1, 2**sc), (2**sc, np.int0(N / 2) - 1)]
if scaling_regime == "1_scale":
    k_range = []
